...
def lambda_handler(event:, context:)
  ...
  begin
    begin
      ...
      # wait = Selenium::WebDriver::Wait.new(timeout: 5) #ローカルスクレイピング用

      pp "ANAサイト(魚介類の週間ランキング一覧)へ"
      d.navigate.to 'https://furusato.ana.co.jp/products/ranking.php?p=ranking_weekly&c=CL002'
    rescue => e
      pp e
      sleep(1)
      retry_cnt += 1
    ...
    sheet = sheets.worksheet_by_title("魚介類") #タブの指定
